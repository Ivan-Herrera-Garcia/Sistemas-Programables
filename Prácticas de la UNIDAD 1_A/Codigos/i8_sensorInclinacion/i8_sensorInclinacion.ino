// Practica 8. Uso del sensor de inclinación
int inPin = 3;
//Establishes the number of the input pin (tilting sensor)
int reading;
//Establishes the current reading from the input pin (tilting
sensor)
int RedLedPin = 13;
//Establishes the number of the Red LED output pin
const int SpeakerPin = 6; // Establishes the number of the Speaker/Buzzer pin
void setup(){
pinMode (inPin, INPUT);
//This will set inPin as INPUT
...
if (reading == 1) {
//If the reading is 1 or True it will process the codes
under it
